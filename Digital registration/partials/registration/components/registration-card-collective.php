...
<table class="table" id="table-copy_of_registration">
    ...
    <? // CONTACTPERSONEN ?>
    <tr>
        <td class="heading offset-top">Relaties</td>
        <td>&nbsp;</td>
    </tr>
    ...
    <? foreach ($registrationCard->contactPersons as $contactPerson): ?>
        ...
        <? if (isset($contactPerson->address->street) && !empty($contactPerson->address->street)) { ?>
            <tr>
                <td class="heading subcat">Woonadres</td>
                <td colspan="<?=$colspan;?>">
        ...
        <tr>
            ...
            <td colspan="<?=$colspan;?>"><?= isset($contactPerson->originOfResources) ? $contactPerson->originOfResources : ""; ?></td>
        </tr>
