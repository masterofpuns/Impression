<div class="section well" data-section='individual'>
    ...
    <div class="form-group">
        <div class="row">
            <div class="form-item col-12 ">
                <label for="form_relation-individual-salutation" class="form-label"><?= t("SALUTATION"); ?>*</label>
                    <select name="Relation[Individual][salutationId]" id="form_relation-individual-salutation" class="form-select">
        ...
        <div class="row">
            <div class="form-item col-12">
                ...
                <input
                    type="text"
                    name="Relation[Individual][titleBefore]"
        ...
        <div class="row">
            <div class="form-item col-12">
                ...
                <input
                    type="text"
                    name="Relation[Individual][initials]"
        ...
        <div class="row">
            <div class="form-item col-12">
                <label for="form_relation-individual-last_name_prefix" class='form-label'><?= t("LAST_NAME_PREFIX"); ?></label>
                <input
                    type="text"
                    name="Relation[Individual][lastNamePrefix]"
        ...
        <div class="row">
            <div class="form-item col-12">
                ...
                <input
                    type="text"
                    name="Relation[Individual][lastName]"
        ...
        <div class="row">
            <div class="form-item col-12">
                ...
                <input
                    type="text"
                    name="Relation[Individual][titleAfter]"
                    id="form_relation-individual-title_after"
                    class='form-control'
                    value="<?= !empty($relation) && !empty($relation->typeObject) && !empty($relation->typeObject->titleBefore) ? $relation->typeObject->titleAfter : ''; ?>"
                    >
            </div>
        </div>
        <div class="row">
            <div class='form-item col-12'>
                ...
                <input
                    type="text"
                    name="Relation[Individual][firstName]"
