// INCLUDES
<?php
    $app->renderJavascript($app->doc->environment->template->getPath() . '/partials/js/modal-relation-note.js');
...
// LISTENERS
document.querySelectorAll('[data-hook="view-relation-edit"]').forEach(btn => {
